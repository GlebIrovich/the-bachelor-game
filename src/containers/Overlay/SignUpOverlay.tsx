...
const SignUpOverlay = () => {
  ...
  const inputIsValid = () =>
    inputValues[InputField.EMAIL] &&
    inputValues[InputField.USERNAME] &&
    inputValues[InputField.PASSWORD];
      ...
      <OverlayWidget
        ...
        actions={
          <UsersQuery
            ...
            variables={{ email: inputValues[InputField.EMAIL] }}
          >
            {({ data, error }) => (
              <InsertUserMutation
                        ...
                        if (inputIsValid()) {
                          insertUser().then((response) => {
                            if (
                              response &&
                              response.data &&
                              response.data.insert_users.returning.length
                            ) {
